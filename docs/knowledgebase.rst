...
.. raw:: html
    ...
    <p>
        ...
        <a class="btn btn-primary" target="_blank" href="docs\extra\insider-threat-ttp-kb.csv" download="insider-threat-ttp-kb.csv">
        <i class="fa fa-download"></i> Download CSV</a>

        <a class="btn btn-primary" target="_blank" href="/extra/insider-threat-ttp-knowledgebase.json" download="insider-threat-ttp-kb.json">
