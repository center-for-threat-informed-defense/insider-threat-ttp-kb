...
contributors into a :doc:`secure case submission portal <portalguide>`. Contributors provided
a sequential list of TTPs per case, with additional information on the data sources used
to detect those TTPs, observable human indicators, and notes about the subject. The data
in the knowledge base includes the following:
